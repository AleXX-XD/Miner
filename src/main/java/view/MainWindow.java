                    ...
                    public void mousePressed(MouseEvent e) {
                        ...
                        switch (e.getButton()) {
                            case MouseEvent.BUTTON1 : {
                                listener.onMouseClick(x, y, ButtonType.LEFT_BUTTON, e);
                                break;
                            }
                            case MouseEvent.BUTTON3 : {
                                listener.onMouseClick(x, y, ButtonType.RIGHT_BUTTON, e);
                                break;
                            }
                            default : {
                            }
                    ...
                    public void mouseReleased(MouseEvent e) {
                        ...
                        switch (e.getButton()) {
                            ...
                            case MouseEvent.BUTTON2 : {
                                listener.onMouseClick(x, y, ButtonType.MIDDLE_BUTTON, e);
                                break;
                            }
                            case MouseEvent.BUTTON3 : {
                                listener.onMouseClick(x, y, ButtonType.RIGHT_BUTTON, e);
